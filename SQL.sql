...
-- the and operator has greater priority than the or operator

-- In logical operator
select * from TblName where ColName in (value1,...,valuek);
-- this means: colName = value1 or ...ColName = valuek

-- Not logical operator
select * from TblName where ColName not in (value1,...,valuek);
-- the not operator can only be before in/between ...and/exists